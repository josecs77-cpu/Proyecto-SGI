...
const DashboardAIInsights: React.FC<DashboardAIInsightsProps> = ({ systemContext }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-[40px] shadow-2xl border border-slate-200 overflow-hidden group hover:shadow-[0_20px_50px_rgba(0,51,153,0.15)] transition-all duration-500"
    >
      ...
      <div className="p-10 min-h-[220px] flex flex-col justify-center bg-slate-50/30">
        <AnimatePresence mode="wait">
            ...
            >
                ...
                <p className="text-[10px] font-black uppercase tracking-widest animate-pulse">Sincronizando con el motor estratégico Jules...</p>
            </motion.div>
            ) : errorStatus === "quota" ? (
            <motion.div
                key="quota"
